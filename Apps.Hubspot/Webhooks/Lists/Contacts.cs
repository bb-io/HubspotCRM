...
public class Contacts : BaseWebhookList
{
    ...
    public Task<WebhookResponse<AssociationChangedPayload>> OnContactAssociationChanged(
        ...
        => HandleAssociationChangedWebhookResponse(webhookRequest, new() { AssociationType = input.AssociationType, IsPrimaryAssosiation = input.IsPrimaryAssosiation, AssociationRemoved = input.AssociationRemoved });
